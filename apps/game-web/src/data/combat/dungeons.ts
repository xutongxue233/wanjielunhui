...
export const CHAPTERS: ChapterConfig[] = [
  ...
  },
  {
    id: 6,
    name: '化神修罗场',
    description: '远古修罗界的战场遗迹，充斥着无尽杀戮之气，化神期修士的试炼之地',
    element: 'fire',
    stages: [
      {
        id: '6-1',
        ...
        stage: 1,
        requiredLevel: 25,
        enemyIds: ['shura_warrior', 'flame_demon'],
        enemyLevelBonus: 0,
        rewards: {
          exp: 3000,
          spiritStones: 1500,
          drops: [
            { itemId: 'shura_blood', chance: 0.5, quantity: 1 },
            { itemId: 'fire_essence', chance: 0.4, quantity: 2 },
          ],
        },
        sweepCost: 65,
      },
      {
        id: '6-2',
        name: '血战沙场',
        description: '修罗将军率领的精锐战场，金甲傀儡护卫左右',
        chapter: 6,
        stage: 2,
        requiredLevel: 26,
        enemyIds: ['shura_general', 'golden_puppet'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 4500,
          spiritStones: 2500,
          drops: [
            { itemId: 'shura_blood', chance: 0.6, quantity: 2 },
            { itemId: 'demon_core', chance: 0.3, quantity: 1 },
            { itemId: 'golem_core', chance: 0.3, quantity: 1 },
          ],
        },
        sweepCost: 75,
      },
      {
        id: '6-3',
        name: '修罗王座',
        description: '修罗王的王座所在，挑战修罗界的至高霸主',
        chapter: 6,
        stage: 3,
        requiredLevel: 28,
        enemyIds: ['flame_demon', 'shura_king'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 6000,
          spiritStones: 3500,
          drops: [
            ...
            { itemId: 'huashen_soul_gem', chance: 0.05, quantity: 1 },
          ],
        },
        sweepCost: 85,
      },
  ...
  },
  {
    id: 7,
    name: '合体秘境',
    description: '天地法则交织之地，合体期修士才有资格踏入的禁地，蕴含远古机缘',
    element: 'neutral',
    stages: [
      {
        id: '7-1',
        name: '雷霆禁地',
        description: '天雷傀儡把守的入口，雷电交加',
        chapter: 7,
        stage: 1,
        requiredLevel: 29,
        enemyIds: ['thunder_puppet', 'ancient_dragon'],
        enemyLevelBonus: 0,
        rewards: {
          exp: 8000,
          spiritStones: 4000,
          drops: [
            ...
            { itemId: 'healing_pill_heti', chance: 0.3, quantity: 1 },
          ],
        },
        sweepCost: 90,
      },
      {
        id: '7-2',
        name: '九幽魔域',
        description: '九幽魔将盘踞之地，阴气冲天',
        chapter: 7,
        stage: 2,
        requiredLevel: 31,
        enemyIds: ['jiuyou_demon_general', 'chaos_beast'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 12000,
          spiritStones: 6000,
          drops: [
            ...
            { itemId: 'demon_core', chance: 0.6, quantity: 3 },
          ],
        },
        sweepCost: 100,
      },
      {
        id: '7-3',
        name: '法则之巅',
        description: '合体期大能坐镇之地，天地法则凝实可见',
        chapter: 7,
        stage: 3,
        requiredLevel: 32,
        enemyIds: ['sky_demon', 'heti_powerhouse'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 16000,
          spiritStones: 8000,
          drops: [
            { itemId: 'heti_pill', chance: 0.05, quantity: 1 },
  ...
  },
  {
    id: 8,
    name: '大乘天劫',
    description: '天劫降临之地，雷霆交织，是大乘期修士证道之处',
    element: 'metal',
    stages: [
      {
        id: '8-1',
        name: '仙界前哨',
        description: '仙界守卫镇守的关隘，仙威浩荡',
        chapter: 8,
        stage: 1,
        requiredLevel: 33,
        enemyIds: ['immortal_guard', 'void_rift_beast'],
        enemyLevelBonus: 0,
        rewards: {
          exp: 18000,
          spiritStones: 9000,
          drops: [
            { itemId: 'thunder_essence', chance: 0.3, quantity: 1 },
            { itemId: 'healing_pill_dacheng', chance: 0.3, quantity: 1 },
          ],
        },
        sweepCost: 120,
      },
      {
        id: '8-2',
        name: '太古龙巢',
        description: '太古妖龙的巢穴，到处是龙骨遗骸',
        chapter: 8,
        stage: 2,
        requiredLevel: 34,
        enemyIds: ['ancient_demon_dragon', 'dacheng_cultivator'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 22000,
          spiritStones: 11000,
      ...
      },
      {
        id: '8-3',
        name: '天劫核心',
        description: '天劫凝聚之地，雷霆化身与天道执行者守护此处',
        chapter: 8,
        stage: 3,
        requiredLevel: 35,
        enemyIds: ['tribulation_thunder_avatar', 'dao_enforcer'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 28000,
          spiritStones: 14000,
          drops: [
            ...
            { itemId: 'dacheng_pill', chance: 0.05, quantity: 1 },
            { itemId: 'dujie_pill', chance: 0.03, quantity: 1 },
          ],
        },
        sweepCost: 140,
      },
  ...
  },
  {
    id: 9,
    name: '仙界之门',
    description: '通往仙界的最终之门，只有渡过天劫的强者才有资格挑战',
    element: 'fire',
    stages: [
      {
        id: '9-1',
        name: '劫雷炼狱',
        description: '无尽劫雷交织的炼狱，天劫守护者把守',
        chapter: 9,
        stage: 1,
        requiredLevel: 35,
        enemyIds: ['tribulation_guardian', 'tribulation_thunder_avatar'],
        enemyLevelBonus: 0,
        rewards: {
          exp: 30000,
          spiritStones: 15000,
          drops: [
            { itemId: 'thunder_essence', chance: 0.5, quantity: 2 },
            { itemId: 'healing_pill_dujie', chance: 0.3, quantity: 1 },
          ],
        },
        sweepCost: 150,
      },
      {
        id: '9-2',
        name: '魔君殿堂',
        description: '渡劫魔君的领地，魔气与天劫交织',
        chapter: 9,
        stage: 2,
        requiredLevel: 35,
        enemyIds: ['tribulation_demon_king', 'fallen_true_immortal'],
        enemyLevelBonus: 1,
        rewards: {
          exp: 40000,
          spiritStones: 20000,
