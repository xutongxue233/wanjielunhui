...
export const CONSUMABLE_ITEMS: Record<string, ItemDefinition> = {
  ...
  healing_pill_low: {
    id: 'healing_pill_low',
    name: '低阶疗伤丹',
    description: '入门修士常备丹药，服用后恢复60点生命值',
    type: 'consumable',
    quality: 'common',
    stackable: true,
    maxStack: 99,
  ...
  reincarnation_pill: {
    id: 'reincarnation_pill',
    name: '轮回丹',
    description: '蕴含残缺轮回道韵的奇丹，服用后可迅速稳固初期修为',
    type: 'consumable',
    quality: 'epic',
    stackable: false,
    maxStack: 1,
    sellPrice: 600,
    effects: [{ type: 'add_cultivation', value: 180 }],
  },
};
...
export const QUEST_ITEMS: Record<string, ItemDefinition> = {
  ...
  broken_technique_manual: {
    id: 'broken_technique_manual',
    name: '残缺功法残卷',
    description: '山洞中拾得的破旧功法，虽不完整，却足以引你入道。',
    type: 'quest',
    quality: 'uncommon',
    stackable: false,
    maxStack: 1,
  ...
  clan_technique_manual: {
    id: 'clan_technique_manual',
    name: '家传功法玉简',
    description: '记载着家族养气心法的玉简，是重振门楣的希望。',
    type: 'quest',
    quality: 'rare',
    stackable: false,
    maxStack: 1,
  ...
  mysterious_jade_pendant: {
    id: 'mysterious_jade_pendant',
    name: '神秘玉佩',
    description: '家族遗留下来的玉佩，内部似乎藏着尚未解开的秘密。',
    type: 'quest',
    quality: 'rare',
    stackable: false,
    maxStack: 1,
  ...
  sealed_memory_fragment: {
    id: 'sealed_memory_fragment',
    name: '封印记忆碎片',
    description: '前世残魂中剥离出的记忆碎片，偶尔会在冥想时自行震颤。',
    type: 'quest',
    quality: 'epic',
    stackable: false,
    maxStack: 1,
